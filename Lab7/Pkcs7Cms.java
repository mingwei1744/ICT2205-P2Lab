...
public class Pkcs7Cms 
{
	public static void main(String[] args) 
	{
		...
		String privKeyFile = System.getProperty("user.dir") + "\\src\\priv.pem";
		...
		try {
			...
			// encrypt
			byte[] envelopedData = pkcs7cms.encryptDataWithRSA_OAEPinPKCS7(data, cert);
			pkcs7cms.writeEncodedPKCS7CmsFile(p7envFile, envelopedData);
			
			// sign
			byte[] signedData = pkcs7cms.signDataWithRSA_PSSinPKCS7(data, cert, privKey);
			pkcs7cms.writeEncodedPKCS7CmsFile(p7sigFile, signedData);
			
			// Read EnvData file
			PEMParser pemParser = new PEMParser(new FileReader(p7envFile));
			Object o = pemParser.readObject();
			
			// TODO: CMS Information
			CMSEnvelopedData cmsEnvelopedData = new CMSEnvelopedData((ContentInfo)o);
			System.out.println("Algorithm OID: "+ cmsEnvelopedData.getEncryptionAlgOID());;
	...
	{     
		...
		// specify RSA-OAEP parameters Lecture7b slide 6
		...
		System.out.println("Key Encryption Algoritm OID: " + ri.getKeyEncryptionAlgOID());
		System.out.println("Encryption Algorithm OID: " + cmsEnvelopedData.getContentEncryptionAlgorithm().getAlgorithm().getId());
	...
	// Function to write to CMS File (p7FileName, Bytes)
